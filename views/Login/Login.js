...
export class Login extends React.Component {
    ...
    render() {
        ...
        if (this.state.loading) {
            ...
            display.push(
                <TouchableOpacity style={{ flex: 1, backgroundColor: '#e9b2bc', borderRadius: 2, padding: 10, }} onPress={() => this._getLogin()}>
        ...
        return (
            <ScrollView style={{ backgroundColor: "#f3dfe3", }}>
